...
* Outputs (vout):
* Value: Specifies the amount of Bitcoin being sent to each output.
* Locking Script (scriptPubkey): Defines conditions for spending the output in future transactions.
